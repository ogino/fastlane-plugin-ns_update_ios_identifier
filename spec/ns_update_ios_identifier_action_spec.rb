describe Fastlane::Actions::NsUpdateIosIdentifierAction do
  describe "#run" do
    # Variables
    ...
    it "updates the info plist when product bundle identifier not in use" do
      ...
      Fastlane::Actions::NsUpdateIosIdentifierAction.run(
        xcodeproj: "#{xcodeproj}",
    ...
    xit "updates the xcode project when product bundle identifier in use" do
    ...
    xit "updates the xcode project when product bundle identifier in use and it uses curly brackets notation" do
      stub_project = "stub project"
      stub_configuration_1 = "stub config 1"
      stub_configuration_2 = "stub config 2"
      stub_object = ["object"]
    ...
    xit "updates the xcode project when info plist path contains $(SRCROOT)" do
      stub_project = "stub project"
      stub_configuration_1 = "stub config 1"
      stub_configuration_2 = "stub config 2"
      stub_object = ["object"]
    ...
    xit "updates the xcode project when info plist path not contains $(SRCROOT)" do
      stub_project = "stub project"
      stub_configuration_1 = "stub config 1"
      stub_configuration_2 = "stub config 2"
      stub_object = ["object"]
    ...
    xit "should raise an exception when PRODUCT_BUNDLE_IDENTIFIER in info plist but project doesn't use this info plist" do
      stub_project = "stub project"
